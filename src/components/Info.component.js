...
const Info = () => {
  return (
    <section className="text-center p-8 w-full md:px-32 lg:text-left lg:p-0 lg:max-w-[300px]">
      <h1 className="tracking-[10.83px] text-[40px] space-y-6 mb-4 lg:text-[64px] lg:px-0">
